				...
				<div class="row">
					<div class="col-xs-12">
						<div class="article-header">
							...
							<h2 class="page-header title"><a href="#">Latest Article #1</a></h2>
							<h6 class="author">By Author Name, Another Name | <a href="#" class="article-timestamp">26 June 2015, 4:41 PM</a></h6>
						</div><!-- /.article-header -->
